...
public class Humidity extends Data{
	 ...
	 * @param value
	 */
	public Humidity(int year, int month, int dayOfMonth, int hour, int minute, double value) {
	 ...
	 * @param value
	 */
	public Humidity(int year, int month, int dayOfMonth, int hour, int minute, int second, double value) {
	 ...
	 * @param value
	 */
	public Humidity(int year, int month, int dayOfMonth, int hour, int minute, int second, int nanoOfSecond,
			double value) {
	 ...
	 * @param value
	 */
	public Humidity(LocalDateTime dateAndTime, double value) {
