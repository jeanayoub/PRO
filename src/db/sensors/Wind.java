...
public class Wind extends Data{
	 ...
	 * @param value
	 */
	public Wind(int year, int month, int dayOfMonth, int hour, int minute, double value) {
	 ...
	 * @param value
	 */
	public Wind(int year, int month, int dayOfMonth, int hour, int minute, int second, double value) {
	 ...
	 * @param value
	 */
	public Wind(int year, int month, int dayOfMonth, int hour, int minute, int second, int nanoOfSecond, double value) {
	 ...
	 * @param value
	 */
	public Wind(LocalDateTime dateAndTime, double value) {
